 ...
 * |   Z  |   X  |   C  |   D  |   V  |      |      |   K  |   H  |   ,  |   .  |   '  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |SYMBL | LOWER|      |      | RAISE|BKSP  |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_grid(
    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_TRNS, KC_TRNS, KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, 
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, SYMBL,   LOWER,   KC_TRNS, KC_TRNS, RAISE,   GRSYM,   KC_TRNS, KC_TRNS, KC_TRNS  
),

// KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_TRNS, KC_TRNS, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    
/* Lower/Nav
 * ,-----------------------------------------------------------------------------------.
 * | Del  |  Ins |  Up  | PG UP|CAPSLK|      |      |Vol Up|  MS1 | MSUP | MS2  | MSWU |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Home | Left | Down | Rght | End  |      |      |Vol Dn|  MSLF| MSDN | MSRT | MSWD |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ESC  |Web BK|Web FD| PG DN|      |      |      | Mute |  MSWL|      | MSWR |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      | Del  |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
    KC_DEL,  KC_INS,  KC_UP,   KC_PGUP, KC_CAPS, KC_TRNS, KC_TRNS, KC_VOLU, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, 
    KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_TRNS, KC_TRNS, KC_VOLD, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, 
    KC_ESC,  KC_WBAK, KC_WFWD, KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_WH_L, KC_TRNS, KC_WH_R, KC_TRNS, 
...
[_RAISE] = LAYOUT_planck_grid(
	KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_TRNS, KC_TRNS, KC_TRNS, KC_EQL,  KC_7,    KC_8,    KC_9,    KC_MINS, 
    KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS, KC_TRNS, KC_TRNS, KC_DOT,  KC_4,    KC_5,    KC_6,    KC_PLUS, 
    KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS, KC_TRNS, KC_0,    KC_1,    KC_2,    KC_3,    KC_ASTR, 
...
[_SYMBL] = LAYOUT_planck_grid(
	KC_GRV,  KC_TILD, KC_QUES, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_EQL,  KC_AMPR, KC_ASTR, KC_LPRN, KC_MINS, 
    KC_LCBR, KC_LBRC, KC_LPRN, KC_SLSH, KC_PIPE, KC_TRNS, KC_TRNS, KC_UNDS, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, 
    KC_RCBR, KC_RBRC, KC_RPRN, KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_RPRN, KC_EXLM, KC_AT,   KC_HASH, KC_ASTR, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS 
),

/* Function Layer
 * ,-----------------------------------------------------------------------------------.
 * |      | Reset|Debug | eerst|cole  |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | HUE+ | SAT+ |BRGTH+| RGB  |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | HUE- | SAT- |BRGTH-|RGBMD |      |      |      |      |      |      |      |      |
...
[_FNCTN] = LAYOUT_planck_grid(
    KC_TRNS, QK_BOOT, DB_TOGG, EE_CLR,  COLEMAK, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
    RGB_HUI, RGB_SAI, RGB_VAI, RGB_TOG, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
    RGB_HUD, RGB_SAD, RGB_VAD, RGB_MOD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS ,KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
