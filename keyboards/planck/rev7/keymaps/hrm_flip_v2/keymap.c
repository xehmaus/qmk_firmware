...
[_COLEMAK] = LAYOUT_planck_grid(
    HOME_Q,  HOME_W,  HOME_F,  HOME_P,  KC_B,    KC_TRNS, KC_TRNS, KC_J,    HOME_L,  HOME_U,  HOME_Y,  HOME_SCLN,
    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_TRNS, KC_TRNS, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,      
    FNCTN,   KC_X,    KC_C,    KC_D,    KC_V,    KC_TRNS, KC_TRNS, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_QUOT, 
 ...
 * |   .  |   6  |   5  |   4  |   -  |      |      |      | F5   |  F6  |  F7  | F8   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   *  |   3  |   2  |   1  |   =  |      |      |      | F9   |  F10 |  F11 | F12  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_NUMLR] = LAYOUT_planck_grid(
	KC_0,    KC_9,    KC_8,    KC_7,    KC_PLUS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4, 
    KC_DOT,  KC_6,    KC_5,    KC_4,    KC_MINS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F5,   KC_F6,   KC_F7,   KC_F8, 
    KC_ASTR, KC_3,    KC_2,    KC_1,    KC_EQL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_F9,   KC_F10,  KC_F11,  KC_F12,
...
[_SYMBL] = LAYOUT_planck_grid(
	KC_RPRN, KC_LPRN, KC_ASTR, KC_AMPR, KC_PLUS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_QUES, KC_TILD, KC_GRV,  
    KC_TRNS, KC_CIRC, KC_PERC, KC_DLR,  KC_UNDS, KC_TRNS, KC_TRNS, KC_PIPE, KC_SLSH, KC_LPRN, KC_LBRC, KC_LCBR, 
    KC_TRNS, KC_HASH, KC_AT,   KC_EXLM, KC_EQL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS, KC_RPRN, KC_RBRC, KC_RCBR, 
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS 
),

/* Function Layer                     
 * ,-----------------------------------------------------------------------------------.
 * |  esc |  ins |      |      |      |      |      |Vol Up| cole |eerst | debug| reset|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_FNCTN] = LAYOUT_planck_grid(
    KC_ESC,  KC_INS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLU, COLEMAK, EE_CLR,  DB_TOGG, QK_BOOT, 
